...
var World = {
	...
	locationChanged: function locationChangedFn(lat, lon, alt, acc) {
		...
		/*
			...
			if the function was already called. With the first call of World.onLocationChanged an object 
			that contains geo information will be created which will be later used to create a marker using 
